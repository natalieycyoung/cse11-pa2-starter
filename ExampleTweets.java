...
//		System.out.println("\nUser 3: " + user3Text);	// User 3: Night of the Living Discourse @ambernoelle		
		...
		//		System.out.println("Link: " + tweet2.toLink());
		...
		//			and, well : 286 Likes	
		//		System.out.println("Link: " + tweet3.toLink());
		...
		//			Likes
		//		System.out.println("Link: " + tweet4.toLink());
		//			Link: https://twitter.com/ambernoelle/status/1430195040261971968


		// Method Examples
//		System.out.println("\nlongerThan test: " + tweet1.longerThan(tweetTest));
//		System.out.println("\nmoreLikes test: " + tweet1.moreLikes(tweetTest));
	}
}
